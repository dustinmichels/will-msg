...
<template>
  <div class="flex-1 flex items-center justify-center p-6 md:p-12 overflow-y-auto">
    ...
    >
      <!-- Upload Icon -->
      <div class="w-20 h-20 mb-4 rounded-full bg-truck-500/10 dark:bg-truck-500/20 text-truck-500 flex items-center justify-center">
      ...
      <div class="flex flex-wrap items-center justify-center gap-4">
        ...
        >
          <svg class="w-5 h-5 text-truck-600 dark:text-truck-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <!-- Scanning Indicator -->
      <div v-if="parseStore.isScanning" class="mt-6 flex items-center gap-2 text-sm text-truck-600 dark:text-truck-400 font-medium">
