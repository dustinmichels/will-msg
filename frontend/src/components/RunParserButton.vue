  ...
  try {
    ...
    if (res.records.length === 0) {
      ...
      if (res.skipped && res.skipped.length > 0) {
        toast.warning(
          `Parsed ${res.records.length} records. ${res.skipped.length} source file(s) were skipped due to errors.`,
...
<template>
  <button
    ...
    :class="
      parseStore.isParsing ? 'bg-truck-600' : 'bg-truck-500 hover:bg-truck-600 active:bg-truck-600'
    "
    @click="handleRunParser"
  >
    <svg
      v-if="parseStore.isParsing"
