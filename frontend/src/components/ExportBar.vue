  ...
  <div class="flex items-center justify-between gap-3 py-2 select-none">
    ...
    >
      <div class="space-y-4">
        ...
        <div class="rounded-lg bg-slate-50 dark:bg-slate-900/80 p-3 border border-slate-200 dark:border-slate-750 space-y-2 text-xs">
          <div>
            <span class="font-semibold text-slate-500 dark:text-slate-400 block mb-0.5">File Name:</span>
            <span class="font-mono text-slate-800 dark:text-slate-200 select-all break-all font-medium">{{ savedFileInfo?.filename }}</span>
          </div>
          <div>
            <span class="font-semibold text-slate-500 dark:text-slate-400 block mb-0.5">Saved To:</span>
            <span class="font-mono text-slate-600 dark:text-slate-400 select-all break-all">{{ savedFileInfo?.dir }}</span>
          </div>
        </div>
      </div>
